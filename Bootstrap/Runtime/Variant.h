...
namespace Detail {
    ...
    struct Variant<IndexType, InitialIndex, F, Ts...> {
        ...
        ALWAYS_INLINE static void move_(IndexType oldId, void* oldData, void* newData) {
            ...
            if (oldId == currentIndex) {
                ...
                new (newData) F(move(*bit_cast<F*>(oldData)));
            }
            else {
        ...
        ALWAYS_INLINE static void copy_(IndexType oldId, void const* oldData, void* newData) {
            ...
            if (oldId == currentIndex) {
                ...
                new (newData) F(*bit_cast<F const*>(oldData));
            }
            else {
    ...
    struct InheritFromUniqueEntries<I, ParameterPack<Ts...>, IndexSequence<Js...>, Qs...> : public BlankIfDuplicate<Ts, Conditional<Js <= I, ParameterPack<>, Qs>...>... {
    ...
    struct InheritFromPacks<IndexSequence<Is...>, Ps...> : public InheritFromUniqueEntries<Is, Ps, IndexSequence<Is...>, Ps...>... {
...
template<typename... Ts>
struct Variant : public Detail::MergeAndDeduplicatePacks<Detail::VariantConstructors<Ts, Variant<Ts...>>...> {
...
#ifdef RUNTIME_HAS_CONDITIONALLY_TRIVIAL
...
private:
    ...
    alignas(dataAlignment) u8 m_data[dataSize];
